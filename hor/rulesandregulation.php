	...
	<div style = "margin-left:0;" class = "container">
		<div class = "panel panel-default">
			<div class = "panel-body">
				...
				<p>Please present your ID card, Passport or Temporary Residence Card upon Check-in. By Law visitors must present personal documents for room records. These documents will be returned upon departure.</p>
				<br />
				...
				<p>It is agreed that the guest will conduct him/ herself in a respectable manner and will not cause any nuisance or annoyance within the room.</p>
				<br />
				<strong><h4 style = "color:#ff0000;">11. Government rules and regulations and application of laws</h4></strong>
